...
const switchLink = document.getElementById('toggle-mode');
...
function toggleMode() {
    ...
    if (mode === 1) {
        ...
        switchLink.innerHTML = 'Déjà inscrit ? <a href="#">Se connecter</a>';
        ...
        switchLink.innerHTML = 'Pas encore de compte ? <a href="#">S\'enregistrer</a>';
